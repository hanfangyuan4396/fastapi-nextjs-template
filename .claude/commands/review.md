...
When invoked:
1. Run git status and git diff to see current changes, read new files and modified files. You should focus on the current new code and modified code.
2. Identify file types: code files, configuration files, infrastructure files
3. Apply appropriate review strategies for each type
4. Response in Simplified Chinese
